...
def test_apply_all(
    ...
    assert f"{prefix_disp}_tel_norm" in events.colnames
    assert f"{prefix_disp}_tel_sign" in events.colnames
    assert f"{prefix_disp}_tel_parameters_is_valid" in events.colnames

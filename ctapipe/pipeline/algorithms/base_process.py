...
class BaseProcess():
	...
	"""
    {'module': 'ctapipe.pipeline.algorithms.list_producer_process', 'source_dir': '/home/jacquem/workspace/demo/0-PRUN',
        'executable': 'ls', 'name': 'PRODUCER_LISTFILE', 'class': 'ListProducerProcess'}
    ...
    def init(self):
        ...
        try:
            ...
            if self.output_dir != None:
                # If output directory is configure, create it now if it does
                # not already exit
        ...
        try:
            ...
            if self.executable == None:
                print(self.section_name, " :configuration error: ",
    ...
    def build_command(self, input_file):
        ...
        if self.source_dir != None:
            input_file = self.source_dir + '/' + input_file

...
class NominalPlotter:
    ...
    def __init__(self, hillas_parameters, draw_axes=False, **kwargs):
        """
    ...
    def draw_position(self, source_x, source_y, use_centre=False, **kwargs):
        ...
        None
        """
        self.array.add_polygon(centroid=(source_x.to(u.deg).value,source_y.to(u.deg).value), radius=10, nsides=3, **kwargs)
        if use_centre:

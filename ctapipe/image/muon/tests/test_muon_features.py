...
def test_ring_containment():
    ...
    ring_cont = ring_containment(ring_radius, cam_radius, ring_center_x, ring_center_y)

    assert ring_cont <= 1.0 and ring_cont >= 0.0
...
def test_ring_completeness():
    ...
    assert ring_comp <= 1.0 and ring_comp >= 0.0

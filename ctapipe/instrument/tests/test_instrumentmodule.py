...
def test_read_telescope_data():
    ...
    #instr3 = ID.Telescope.read_file(filename3)
    instr4 = ID.Telescope.read_file()
    tel1 = instr1[0]
    #tel2 = instr2[0]
    #tel3 = instr3[0]
    tel4 = instr4[0]

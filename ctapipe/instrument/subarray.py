...
__all__ = ["SubarrayDescription", "read_prod5_layout_file"]


def read_prod5_layout_file(path):
    """
    Read CTA layout files.
    These files are generated by Gernot Maier for the comparison of different subarray layouts.
    ...
    --------
    tel_ids: np.array
        Array of telescope ids
    tel_names: np.array
        Array of human readable names
    """
    layout_selection = np.genfromtxt(
        path,
        dtype=[
            ("tel_id", "i8"),
            ("FoV", "f8"),
...
class SubarrayDescription:
    ...
    def select_subarray(self, tel_ids, name=None, tel_names=None):
        """
        ...
        tel_names: dict
            mapping of tel_id to new telescope name
        Returns
        -------
        SubarrayDescription
        """
    ...
    def rename_telescopes(self, tel_names):
        """
        Change the names of the associated telescopes
        ...
        """
        for tel_id, new_name in tel_names.items():
            self.tel[tel_id].name = new_name

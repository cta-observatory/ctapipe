...
def test_targetio_calibrator():
    ...
    r1c = r1.from_eventsource(eventsource=source_r0)
...
def test_factory_from_product():
    calibrator = r1.from_name("NullR1Calibrator")
    assert isinstance(calibrator, NullR1Calibrator)
    calibrator = r1.from_name("HESSIOR1Calibrator")
    assert isinstance(calibrator, HESSIOR1Calibrator)


def test_factory_default():
    calibrator = r1.from_name()
    assert isinstance(calibrator, NullR1Calibrator)
...
def test_factory_from_eventsource():
    ...
    calibrator = r1.from_eventsource(eventsource=eventsource)
    assert isinstance(calibrator, HESSIOR1Calibrator)

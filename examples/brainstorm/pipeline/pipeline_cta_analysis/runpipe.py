...
from ctapipe.pipeline.zmqpipe import pipeline_zmq
...
if __name__ == '__main__':
	...
	conf.add_argument("-g", "--gui" , dest="gui_address", required=False, default=None,
	help='address and port for GUI. Example: tcp://localhost:5566')

...
#        print(point_azimuth,point_altitude)
    ...
    reco.get_great_circles(hillas_params,event.inst.subarray,point_azimuth,point_altitude)  
    ...
    if np.isnan(reco_direction).any(): continue

    # get angular offset between reconstructed shower direction and MC generated shower direction

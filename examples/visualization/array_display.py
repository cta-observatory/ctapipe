...
ad.axes.scatter(shower_impact.easting, shower_impact.northing, marker="+", s=200)
...
rhos = np.full(subarray.n_tels, 200) * u.m
...
def plot_event(event, subarray, ax):
    ...
    event.monitoring.pointing.azimuth
    ...
    reco_shower = event.dl2.geometry["HillasReconstructor"]

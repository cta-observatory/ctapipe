...
from ctapipe.io import HDF5EventSource, SimTelEventSource
from ctapipe.io.eventseeker import EventSeeker
from ctapipe.utils import get_dataset_path

dataset = get_dataset_path("gamma_prod5.simtel.zst")
...
def test_eventseeker(dl1_file):
    with HDF5EventSource(
        ...
        event = seeker.get_event_id(5105)
        assert event.index.event_id == 5105

        with pytest.raises(IndexError):
            seeker.get_event_index(100)

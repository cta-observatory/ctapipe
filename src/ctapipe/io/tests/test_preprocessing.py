    ...
    table = QTable(
        {
            ...
            "tel_id": [1, 1, 1],
            "ExtraTreesRegressor_energy": [1.0, 2.0, 3.0] * u.TeV,
            "ExtraTreesRegressor_is_valid": [True, False, True],
            "ExtraTreesRegressor_energy_uncert": [0.1, 0.2, 0.1],
            "ExtraTreesRegressor_goodness_of_fit": [0.9, 0.8, 0.95],
            ...
            "ExtraTreesClassifier_prediction": [0.9, 0.8, 0.95],
            "HillasReconstructor_az": [81.0, 82.0, 81.0] * u.deg,
            "HillasReconstructor_alt": [81.0, 82.0, 81.0] * u.deg,
            "subarray_pointing_lat": [20.0, 21.0, 20.0] * u.deg,
            "subarray_pointing_lon": [0, 0.0, 0.0] * u.deg,

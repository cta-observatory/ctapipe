...
class CameraCalibrator(TelescopeComponent):
    ...
    def r1_to_dl0(self, tel_event: TelescopeEventContainer):
        ...
        # FIXME: copy trigger from existing dl0 if there.
        # FIXME: how to deal with trigger information at R1 for simulations?
        if tel_event.dl0 is not None and tel_event.dl0.trigger is not None:
            trigger = tel_event.dl0.trigger
        else:
            trigger = TelescopeTriggerContainer()

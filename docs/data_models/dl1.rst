...
generated by ctapipe (e.g. the ``ctapipe-stage1-process`` tool which uses the
:py:class:`~ctapipe.io.DL1Writer` component to generate output data).
...
(e.g.  ``"CTA ACTIVITY NAME" = "ctapipe-stage1-process"``).

...
CEP stands for "Ctapipe Enhancment Proposal". This is CEP 1, which
describes the purpose of writing CEPs as well as giving some guidelines
on how CEPs are authored, discussed and reviewed.

An CEP is a design document providing information to the community, or 
...
decisions that have gone into Python. The CEP author is responsible for
